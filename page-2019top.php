      ...
      <section id="about" class="clearfix">
        <div class="wrap">
          <div class="card" style="background: #fae053;">
            <div class="title">
              <h1 style="color:black;">名古屋ギターフェスティバル 2019</h1>
              <p style="color:black;"><time>2019.8.3(土)</time> 名古屋・栄 宗次ホール</p>
            </div>
            <hr noshade>
            <div class="body flex_container">
              <div class="info">
                ...
                <p>
                名古屋だけでなく世界からも素晴らしいギタリスト達がこの一日に名古屋に集結！クラシックギターブームを名古屋から生み出す！
                </p>
                <div class="more">
